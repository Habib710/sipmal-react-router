...
import img from './wifi-router-500x500.jpg';
import './home.css';
          ...
          <section className='section-css'>
            <div className='row  m-0 p-0  '>
              <div className='col-6 px-5  sm:col-12'>
                ...
                <br />
                <p><small>Established in the year 2019 at Pune, Maharashtra, we “Kanifa Technology” are a Sole Proprietorship based firm, engaged as the foremost Wholesaler and Trader of Bullet Camera, Dome Camera and much more. Our products are high in demand due to their premium quality and affordable prices. Furthermore, we ensure to timely deliver these products to our clients, through this we have gained a huge clients base in the market.</small></p>
